...
def _truncate_research_data(research_data: str) -> str:
    ...
    keep = RESEARCH_DATA_MAX_CHARS - len(_TRUNCATION_SUFFIX)
    if keep < 0:
        return research_data[:RESEARCH_DATA_MAX_CHARS]
    return research_data[:keep] + _TRUNCATION_SUFFIX
